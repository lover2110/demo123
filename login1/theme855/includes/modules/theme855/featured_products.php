...
if ($num_products_count > 0) {
  ...
  while (!$featured_products->EOF) {
	...
	$products_name = '<a class="name" href="' . zen_href_link(zen_get_info_page($featured_products->fields['products_id']), 'cPath=' . $productsInCategory[$featured_products->fields['products_id']] . '&products_id=' . $featured_products->fields['products_id']) . '">' . substr(strip_tags($featured_products->fields['products_name']), 0, 60) . '</a>';
	...
	$products_butt2 = '<a href="' . zen_href_link(FILENAME_DEFAULT, zen_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $featured_products->fields["products_id"]) . '">' . zen_image_button(BUTTON_IMAGE_ADD_TO_CART, BUTTON_IN_CART_ALT1) . '</a>';
