...
if ($num_products_count > 0) {
  ...
  while (!$new_products->EOF) {
	...
	$products_name = '<a class="name" href="' . zen_href_link(zen_get_info_page($new_products->fields['products_id']), 'cPath=' . $productsInCategory[$new_products->fields['products_id']] . '&products_id=' . $new_products->fields['products_id']) . '">' . substr(strip_tags($new_products->fields['products_name']), 0, 60) . '</a>';
    ...
    $list_box_contents[$row][$col] = array('params' => 'class="centerBoxContentsNew centeredContent back ' . $tm_param . '"',
    'text' => 
