...
// javascript messages
  ...
  define('HEADER_PHONE_SENT', 'Order hotline:');
  define('HEADER_TELEPHONE_CUSTSERVICE', '800-2345-6789');
  define('FOOTER_PHONE_TEXT', 'Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.');
  define('FOOTER_PHONE_SENT', 'ASK OUR EXPERTS');
  define('FOOTER_TEL', '80023456789');
  define('FOOTER_PHONE_INFO', 'Hours 6am-4pm PST M-Th; 6am-3pm PST Fri');
