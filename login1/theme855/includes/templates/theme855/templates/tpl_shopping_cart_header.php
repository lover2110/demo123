  ...
  if ($_SESSION['cart']->count_contents() > 0) {
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
		...
		$content .= '<div class="cart_item">
						<div class="left-info">
							<a class="cart-img" href="' . zen_href_link(zen_get_info_page($products[$i]['id']), 'products_id=' . $products[$i]['id']) . '"><img width="'.SMALL_IMAGE_WIDTH.'" height="'.SMALL_IMAGE_HEIGHT.'" src="'. DIR_WS_IMAGES. '' . $products[$i]['image'] . '"/></a>
						</div>
