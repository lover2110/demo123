 ...
 */
  ...
  if (strtolower(IMAGE_USE_CSS_BUTTONS) == 'no') {
    ...
    $content .= zen_draw_input_field('keyword', '', 'size="18" maxlength="100" class="input1" style="width: ' . ($column_width-85) . 'px"') . ' <input class="search_btn" type="submit" value="' . HEADER_SEARCH_BUTTON . '"  />';
