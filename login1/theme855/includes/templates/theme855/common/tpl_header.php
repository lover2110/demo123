...
?>
	...
	<div class="main-width">
        ...
        <div class="navigation">
            <!-- ========== NAVIGATION LINKS ========== -->
                <a class="frst <?php if($this_is_home_page){?>home<?php } ?>" href="<?php echo HTTP_SERVER . DIR_WS_CATALOG ?>"><?php echo HEADER_TITLE_CATALOG; ?></a>
            ...
            <!-- ========== SHOPPING CART ========== -->
                <?php 
                    if ($_SESSION['cart']->count_contents() == 1){
                        $cart_text = '<a class="on" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL').'"><span class="count">' . $_SESSION['cart']->count_contents() . '</span></a>';
                    } else {
                        $cart_text = '<a class="on" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL').'"><span class="count">' . $_SESSION['cart']->count_contents() . '</span></a>';
                    }
        ...
        <div id="head-search">
            ...
            <div class="phone">
                <h3><?php echo HEADER_PHONE_SENT ?></h3>             
                <h2><?php echo HEADER_TELEPHONE_CUSTSERVICE?></h2>                
            </div>
